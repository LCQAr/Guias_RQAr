...
# Configurações
# =============================
ROOT_PATH = "https://arquivos.lcqar.ufsc.br/rqar-national-guide-files"
BUFFER_PATH = ROOT_PATH + "/data/outputs/buffers_var.gpkg"
SETOR_PATH  = ROOT_PATH + "/data/outputs//BR_setores_pop2022.gpkg"
...
def gerar_cache_populacao():
    ...
    if candidatos:
        ...
        setores = setores[setores["CD_UF"] != 27].copy()
...
def carregar_tabela_pronta(UF):
    ...
    def embed_flag(uf):
        resp = requests.get(f"{FLAGS_DIR}/{uf}.png")
