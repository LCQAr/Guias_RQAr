...
# --- 5. Mapa-base CARTO Voyager com chave de API ---
    ...
    category_colors = dict(zip(unique_categories, colors_hex))
    ...
    for category in unique_categories:
        ...
        # Aumentamos o font-size da bolinha (span) para 20px ou mais
        ...
        subset.explore(
            ...
            marker_kwds={"radius": 8, "fill": True, "weight": 1, "color": "white"}, # Raio maior (8)
            popup=True,
            legend=False
        )
        group.add_to(m)
    ...
    <style>
      ...
      /* Estilo da Caixa de Seleção (Layer Control) */
      ...
      /* Ajuste fino para os itens da legenda */
